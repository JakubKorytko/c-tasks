...
int main()
{
    ...
    printf("Podaj ilosc wierszy macierzy A (i tym samym ilosc kolumn macierzy B): ");
    scanf("%d", &A_size[0]);
    printf("Podaj ilosc kolumn macierzy A (i tym samym ilosc wierszy macierzy B: ");
    scanf("%d", &A_size[1]);
    ...
    int elements[2] = {(A_size[0]-1)*(A_size[1]-1), (B_size[0]-1)*(B_size[1]-1)}; 
