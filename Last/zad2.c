...
int main()
{
    ...
    printf("Podaj skladniki sumy oddzielone spacja w systemie rzymskim z przedzialu <1, 1000>: ");
    scanf("%s %s", &a, &b);
    ...
    {
        printf("\nPodano liczbe z blednego przedzial lub niepoprawny system rzymski");
        return 1;
    }
